...
4- download datasource number 2 (Current depressive symptoms by sex, age, and income quintile)
    preferably in .tsv format from given url(https://ec.europa.eu/eurostat/databrowser/view/hlth_ehis_mh1i$DV_464/default/table?lang=en)
